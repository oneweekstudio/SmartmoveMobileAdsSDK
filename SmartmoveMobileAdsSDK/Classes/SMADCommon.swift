...
public class SMADCommon : NSObject {
    ...
    public func openDeepLink( from controller: UIViewController,
                              link: String = "https://flyingfacev2.page.link/test",
                              nativeDidCloseBlock: (() -> Void)? = nil,
                              nativeLoadBlock: (() -> Void)? = nil) {
        ...
        nativeViewController.nativeDidCloseBlock = nativeDidCloseBlock
        nativeViewController.nativeLoadBlock =  nativeLoadBlock
